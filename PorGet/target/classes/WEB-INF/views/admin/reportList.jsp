		...
		<ul class="pagination">
			...
			<c:forEach var="num" begin="${pageMaker.startPage}"
				...
				<li class="page-item ${pageMaker.cri.pageNum == num ? 'active':'' }">
					<a class="page-link" href="/porget/admin/reportList?pageNum=${num}&amount=10">${num}</a>
				</li>
			</c:forEach>
...
<form id='actionForm' action="/porget/admin/reportList" method='get'>
			...
			.ready(
					function() {
						...
						$('#chatConfirm')
								.click(
										function() {
											var reporturl = "/porget/admin/reportChatting?reporter="
